...
CITIES_DISTRICTS = {
    ...
    "جدة": [
        "أبحر الشمالية", "أبحر الجنوبية", "البساتين", "المرجان", "الشاطئ",
        "النزهة", "النعيم", "النهضة", "الروضة", "الخالدية",
        "السلامة", "الزهراء", "الصفا", "المروة", "الفيصلية",
        "الربوة", "النزهة", "البوادي", "الشرفية", "الرويس",
        "الحمراء", "الأندلس", "مشرفة", "العزيزية", "الرحاب",
        "الورود", "النسيم", "الفيحاء", "الثغر", "الجامعة",
        "الروابي", "السليمانية", "الحمدانية", "الفلاح", "الصالحية",
        "الرحيلي", "المنار", "السامر", "الأجواد", "المنار",
        "حي البلد", "الكندرة", "العمارية", "الصحيفة", "البغدادية",
        "السبيل", "القوزين", "الخمرة", "العدل", "الأمير فواز",
        "القرينية", "السنابل", "الهدى", "الأجاويد", "السنابل"
    ],
    "مكة المكرمة": [
        "المنطقة المركزية", "أجياد", "المسفلة", "الشبيكة", "الغزة", 
        "الروضة", "العزيزية", "النسيم", "البطحاء", "الشوقية", 
        "الكعكية", "الخالدية", "الرصيفة", "الزاهر", "العتيبية", 
        "النزهة", "الشهداء", "الضيافة", "الزهراء", "البحيرات", 
        "النوارية", "الشرائع", "المعيصم", "جبل النور", "العدل", 
        "بطحاء قريش", "العوالي", "بطحاء مكة", "حي السلام", "ولي العهد"
    ]
"نجران": [
