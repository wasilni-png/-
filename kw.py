...
CITIES_DISTRICTS = {
    "المدينة المنورة": [
        ...
        "الدويخي", "الرانوناء", "الشروق", "الشرق", "العاقول", "العريض", "العزيزية", 
        "العنابس", "القبلتين", "الملك فهد", "المطار", "المغيسله", "الهجرة", "باقدو", 
        "بني حارثة", "حديقة الملك فهد", "سيد الشهداء", "شوران", "قباء", "مهزور"
    ],
    "جدة": [
        "أبحر الشمالية", "أبحر الجنوبية", "البساتين", "المرجان", "الشاطئ", "النزهة", 
        "النعيم", "النهضة", "الروضة", "الخالدية", "السلامة", "الزهراء", "الصفا", 
        "المروة", "الفيصلية", "الربوة", "البوادي", "الشرفية", "الرويس", "الحمراء", 
        "الأندلس", "مشرفة", "العزيزية", "الرحاب", "الورود", "النسيم", "الفيحاء", 
        "الثغر", "الجامعة", "الروابي", "السليمانية", "الحمدانية", "الفلاح", 
        "الصالحية", "الرحيلي", "المنار", "السامر", "الأجواد", "حي البلد", 
        "الكندرة", "العمارية", "الصحيفة", "البغدادية", "السبيل", "القوزين", 
        "الخمرة", "العدل", "الأمير فواز", "القرينية", "السنابل", "الهدى", "الأجاويد"
    ],
    "مكة المكرمة": [
        "المنطقة المركزية", "أجياد", "المسفلة", "الشبيكة", "الغزة", "الروضة", 
        "العزيزية", "النسيم", "البطحاء", "الشوقية", "الكعكية", "الخالدية", 
        "الرصيفة", "الزاهر", "العتيبية", "النزهة", "الشهداء", "الضيافة", 
        "الزهراء", "البحيرات", "النوارية", "الشرائع", "المعيصم", "جبل النور", 
        "العدل", "بطحاء قريش", "العوالي", "بطحاء مكة", "حي السلام", "ولي العهد"
    ],
    "نجران": [
        "حي الفهد", "حي الضيافة", "حي الخالدية", "حي العريسة", "حي الفيصلية",
        "حي الروضة", "حي أبا السعود", "حي الشرفة", "حي الحضن", "حي الجربة",
        "حي الغويلا", "حي نهوقة", "حي الرشرشية", "حي القابل", "حي المخيم",
        "حي رجلاء", "حي تسلال", "حي دحضه", "حي بئر عسكر"
    ],
    "الرياض": [
        "الملقا", "الصحافة", "الياسمين", "النرجس", "العقيق", "حطين", "الغدير", 
        "القيروان", "الرمال", "المنار", "الروضة", "الريان", "القدس", "النهضة", 
        "اليرموك", "قرطبة", "أشبيلية", "النسيم", "العليا", "السليمانية", 
        "المربع", "الملز", "طويق", "لبن", "السويدي", "البديعة", "ظهرة البديعة", 
        "عرقة", "المهدية", "الشفا", "بدر", "الدار البيضاء", "العزيزية", "الحاير"
    ]
}
